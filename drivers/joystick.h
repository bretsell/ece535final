...
/* ADD CODE */
#define JOYSTICK_THRESH_X_LEFT_2P475V   (2.475 / 3.3) * 0xFFFF
#define JOYSTICK_THRESH_X_RIGHT_0P825V  (0.875 / 3.3) * 0xFFFF
#define JOYSTICK_THRESH_Y_UP_2P475V     (2.475 / 3.3) * 0xFFFF
#define JOYSTICK_THRESH_Y_DOWN_0P825V   (0.875 / 3.3) * 0xFFFF
